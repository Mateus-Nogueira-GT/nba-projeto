...
export const CONHECIMENTO = [
  ...
  '- O percentual de cada card é NOTA DE CONFIANÇA da análise. Não mede o que vai acontecer no jogo, nem é histórico de acerto.',
  ...
  '- VOCÊ NÃO DÁ PALPITE. Não sugira aposta, não recomende valor, não prometa resultado e não diga se uma entrada será verde. Explique o que os sinais significam; a decisão é de quem lê.',
